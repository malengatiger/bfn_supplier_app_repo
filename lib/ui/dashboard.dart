...
import 'package:bfn_supplier_app_repo/ui/network_accounts.dart';
...
class _DashboardState extends State<Dashboard> {
  ...
  _getNodes() async {
    nodes = await Net.getNodesFromFirestore();
    nodeInfo = await Prefs.getNode();
    print(
        'Dashboard: 💠💠💠💠💠 nodes collected: ${nodes.length}, my node is 💠 ${nodeInfo.toJson()}');
    setState(() {});
  }
  ...
  _refresh() async {
    print('Dashboard: 📯📯📯📯📯📯📯📯 REFRESH DASHBOARD ..... 😻 😻 😻 ');
    if (account == null) {
    ...
    account = await Prefs.getAccount();
    print(
        'Dashboard: 🔵 🔵 🔵 🔵 🔵 🔵 account: ${account.toJson()} 🔵 🔵 🔵 🔵 🔵 🔵 ');
    if (account.host.contains('Regulator')) {
      return;
    }
    print('Dashboard:  🚻  🚻  🚻  🚻  🚻  🚻  🚻  Getting remote data ....');
